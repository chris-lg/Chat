...
public final class Config {
    ...
    public static final String AK="M3cANqENX3vd3LOamFNLZJ8FY9HGYQHIL_7HXBrO";
    
    public static final String SK="50_aXBpg2IFP5QnJmTjghe2a_mGmVI6Oz7V3B0xr";
    
    public static final Auth auth=Auth.create(AK, SK);
    
    public static final String BUNK_NAME="dsservice";
    /**
     * 默认API服务器
     */
